...
assert.equal(entry.schema,'prometeo.agent-entry/v1');
...
console.log(JSON.stringify({ok:true,workstreams:now.active_workstreams.map(x=>x.id),now_revision:now.revision,delta_revision:feed.revision}));
