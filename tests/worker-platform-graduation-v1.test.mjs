...
assert.equal(mission.current_snapshot.occupancy.launch_timing,'GRADUATED_PRODUCTION_POOL');
...
assert.equal(campaign.next_launch.mode,'GRADUATED_PRODUCTION_POOL');
