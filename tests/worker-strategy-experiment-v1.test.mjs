...
assert.ok(['S3_JOB_CLASS_STRATEGIES','S3_S4_S5_PARALLEL_GROWTH','WORKER_PLATFORM_GRADUATION_P1','WORKER_PLATFORM_GRADUATION_P2A_EVOLUTION','WORKER_PLATFORM_GRADUATION_P2B_CONFIRMATION'].includes(trajectory.current_state.active_stage));
if(['WORKER_PLATFORM_GRADUATION_P2A_EVOLUTION','WORKER_PLATFORM_GRADUATION_P2B_CONFIRMATION'].includes(trajectory.current_state.active_stage)) assert.equal(trajectory.current_state.active_experiment,'WORKER-EVOLUTION-LAB-V1');
else assert.equal(trajectory.current_state.active_experiment,'EXP-STRATEGY-AB');
