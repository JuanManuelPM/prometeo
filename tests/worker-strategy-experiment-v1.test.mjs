...
assert.ok(['S3_JOB_CLASS_STRATEGIES','S3_S4_S5_PARALLEL_GROWTH','WORKER_PLATFORM_GRADUATION_P1','WORKER_PLATFORM_GRADUATION_P2A_EVOLUTION'].includes(trajectory.current_state.active_stage));
if(trajectory.current_state.active_stage==='WORKER_PLATFORM_GRADUATION_P2A_EVOLUTION') assert.equal(trajectory.current_state.active_experiment,'WORKER-EVOLUTION-LAB-V1');
