-- AUTO-Q01102: reduce meta-busywork by spacing RESERVOIR_QUALITY audits to 30 minutes.
CREATE OR REPLACE FUNCTION public.prometeo_replenish_reservoir(p_target_ready integer DEFAULT 30, p_max_create integer DEFAULT 15)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
