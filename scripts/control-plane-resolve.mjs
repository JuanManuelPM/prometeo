...
const deltas=(feed.deltas||[]).filter(d=>d.revision>(pack.last_global_revision_seen||0)&&((d.topics||[]).includes('all')||(d.topics||[]).some(t=>topics.has(t))));
...
console.log(JSON.stringify({
  ...
  instruction:'Read WORK_POLICY, then execute from PACK + LAST_RETURN. Do not restart global archaeology or frozen planning unless evidence invalidates the pack.'
},null,2));
