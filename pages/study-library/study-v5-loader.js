(async()=>{
  ...
  try{
    ...
    const files=['./study-v4-core1.js?v=4','./study-v4-core2.js?v=4','./study-v4-live.js?v=4','./study-v5-patch.js?v=5'];
    for(const src of files) await new Promise((resolve,reject)=>{const s=document.createElement('script');s.src=src;s.onload=resolve;s.onerror=reject;document.body.appendChild(s)});
  }catch(e){
    console.error(e);
