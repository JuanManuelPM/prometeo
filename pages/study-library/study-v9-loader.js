(async()=>{
  ...
  try{
    ...
    await load('./study-v9-content.js?v=91');
  }catch(e){console.error(e);if(app)app.innerHTML='<main style="padding:28px;font:14px system-ui;color:#d8d1ff;background:#111326;min-height:100vh">No pude iniciar Study Library. Reintentá en unos segundos.</main>'}
})();